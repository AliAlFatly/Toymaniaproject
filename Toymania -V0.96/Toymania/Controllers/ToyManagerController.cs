...
namespace Toymania.Controllers
{
    ...
    public class ToyManagerController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ToysId,ToysName,CategoryId,ProducerId,ItemArtUrl,Price,Counter,MinimumAge,SubCategoryId,Archive")] Toy toy)
        {
            if (ModelState.IsValid)
            {
