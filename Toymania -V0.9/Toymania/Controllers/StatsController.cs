...
namespace Toymania.Controllers
{
    public class StatsController : Controller
    {
        ...
        public decimal? PMR(int Y, int M)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.Month == M
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public decimal? PMP(int Y, int M)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.Month == M
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public decimal? PWR(int Y, int W)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.Week == W
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public decimal? PWP(int Y, int W)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.Week == W
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public int PCS(int Y, string CN)
        {
            var T = (from od in db.OrderDetails
        ...
        public decimal? PCR(int Y, string CN)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.CName == CN
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public decimal? PCP(int Y, string CN)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.CName == CN
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public int PSS(int Y, string SCN)
        {
            var T = (from od in db.OrderDetails
        ...
        public decimal? PSR(int Y, string SCN)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.SCName == SCN
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
        ...
        public decimal? PSP(int Y, string SCN)
        {
            var T = (from od in db.OrderDetails
                     where od.year == Y && od.SCName == SCN
                     select (int)od.Quantity * (decimal?)od.UnitPrice).ToList();
