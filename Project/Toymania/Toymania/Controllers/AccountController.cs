...
//comment door Ta
        ...
        //toymaniat4@outlook.com    - A@Test@4
        //toymaniat5@outlook.com    - A@Test@5
        ...
        public ActionResult GetBalance()
        {
            ...
            return PartialView("GetBalance", r);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, balance = 0.00m, Role = "Customer" };
        ...
        public async Task<ActionResult> RegisterA(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // ViewBag.Link = callbackUrl;   // Used only for initial demo.
                    //return View("DisplayEmail");
                    return RedirectToAction("Index", "ApplicationUsersController");
                }
                AddErrors(result);
            }
